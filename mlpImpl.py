...
for learn in range(0, 51, 1):
    ...
    for iteration in range(30):
        print(learn ,init - (learn*0.01), iteration)
        oData = Data(7, 10)
        ...
        clf = MLPClassifier_lucas(hidden_layer_sizes=(18,),
                                  ...
                                  learning_rate_init=init - (learn*0.01),
                                  verbose=False,
                                  power_t=0.5,
                                  max_iter=20000,
                                  shuffle=True,
    ...
    oExp.add_data_set(oDataSet, "Experimento variando taxa de aprendixado {} .".format(init - (learn*0.01)))
    oExp.save("Experiment_02_01_MLP_LEARN_BK.gzip")
    oExp.save("Experiment_02_01_MLP_LEARN.gzip")
    print(oExp)
x = []
y = []
y_p = []
